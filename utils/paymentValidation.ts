...
export const validatePaymentForm = async (formData: any): Promise<{
  isValid: boolean;
...
export const formatCreditCardError = (error: any): string => {
  ...
  const errorMessages: Record<string, string> = {
    card_error: 'There was an issue with your credit card. Please check your card details and try again.',
