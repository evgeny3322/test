    ...
    <div class="flex justify-center sticky">
      <form @submit.prevent="{}" class="bg-[#262626] p-6 w-[552px] flex flex-col gap-8 rounded-2xl">
        <p class="text-white text-14 md:text-18">
          We sent a confirmation email to the email {{ registerInfo?.email || '' }}, it will be
          delivered soon, please check your inbox and spam folder, if you didn't receive a
          confirmation email, please double check your address, you could change it on previous
          step.
        </p>
        <!-- First Name -->
        <TrustyField
